...
> **Source:** [leegijun0421/KUAWS](https://github.com/leegijun0421/KUAWS) — this page is the written walkthrough of that code: architecture, the design decisions I made and why, and what I personally owned.
...
| **Jaeyong Lee (이재용)** | Data lead · data collection and curation |
| **Yongjun Heo (허용준)** | Docs & PM lead · documentation and project management |
| **Boxiang Hou (후보향)** | Frontend lead · client application |
